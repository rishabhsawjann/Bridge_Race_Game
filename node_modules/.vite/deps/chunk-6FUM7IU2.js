...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRgbdTextureAsync = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGpu) {
        await import("./rgbdDecode.fragment-SR5AVCE6.js");
      } else {
        await import("./rgbdDecode.fragment-CDPTC22B.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-TXHSWDXW.js");
    } else {
      await import("./rgbdEncode.fragment-XGPEWLPH.js");
    }
...
//# sourceMappingURL=chunk-6FUM7IU2.js.map
