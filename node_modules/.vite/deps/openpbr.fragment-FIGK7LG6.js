import "./chunk-CWBZVM6M.js";
import "./chunk-NWC7BTFI.js";
import "./chunk-OFUICBOR.js";
import "./chunk-643EGQ2L.js";
...
var shader2 = `#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrBlockAmbientOcclusion.js
var name6 = "openpbrBlockAmbientOcclusion";
...
var shader11 = `var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
var name12 = "openpbrCoatLayerData";
var shader12 = `var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
var name13 = "openpbrEnvironmentLighting";
var shader13 = `#ifdef REFLECTION
...
var name14 = "openpbrDirectLightingInit";
...
var name15 = "openpbrDirectLighting";
...
var name16 = "openpbrPixelShader";
var shader16 = `#define OPENPBR_FRAGMENT_SHADER
...
`;
if (!ShaderStore.ShadersStoreWGSL[name16]) {
  ShaderStore.ShadersStoreWGSL[name16] = shader16;
}
var openpbrPixelShaderWGSL = { name: name16, shader: shader16 };
export {
  openpbrPixelShaderWGSL
};
//# sourceMappingURL=openpbr.fragment-FIGK7LG6.js.map
