...
function BindIBLParameters(scene, defines, ubo, reflectionColor, reflectionTexture = null, realTimeFiltering = false, supportTextureInfo = false, supportLocalProjection = false, usePBR = false, supportSH = false, useColor = false) {
...
var TempFinalMat = TmpVectors.Matrix[4];
var TempMat1 = TmpVectors.Matrix[5];
var TempMat2 = TmpVectors.Matrix[6];
...
function OverrideMatrixFunctions(scene) {
...
var ThinBlurPostProcess = class _ThinBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./kernelBlur.fragment-PDM2BKT7.js"), import("./kernelBlur.vertex-JQKWO27Y.js")]));
    } else {
      list.push(Promise.all([import("./kernelBlur.fragment-FJPRGU2O.js"), import("./kernelBlur.vertex-ZKPMAPPQ.js")]));
    }
  }
  /**
...
var ShadowGenerator = class _ShadowGenerator {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        import("./shadowMap.fragment-EXJ4ESW7.js"),
        import("./shadowMap.vertex-63NRRSNI.js"),
        import("./depthBoxBlur.fragment-MWYAH4MM.js"),
        import("./shadowMapFragmentSoftTransparentShadow-4YPOW473.js")
      ]);
    } else {
      await Promise.all([
        import("./shadowMap.fragment-OAEFTNSV.js"),
        import("./shadowMap.vertex-N6YJ6EIV.js"),
        import("./depthBoxBlur.fragment-GFKCCJMM.js"),
        import("./shadowMapFragmentSoftTransparentShadow-YWYSXRQD.js")
      ]);
    }
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-IWW4NBEC.js"), import("./depth.fragment-TCGU57NT.js")]);
    } else {
      await Promise.all([import("./depth.vertex-WMYD3FE7.js"), import("./depth.fragment-GKVADYM4.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
var ThinMinMaxReducerPostProcess = class _ThinMinMaxReducerPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./minmaxRedux.fragment-P55ZPFXD.js"));
    } else {
      list.push(import("./minmaxRedux.fragment-3C3BAP6I.js"));
    }
  }
...
//# sourceMappingURL=chunk-KKCBN2CO.js.map
