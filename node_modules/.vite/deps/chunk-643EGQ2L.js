...
var name9 = "fogFragmentDeclaration";
...
var name10 = "depthPrePass";
var shader10 = `#ifdef DEPTHPREPASS
...
var name13 = "oitFragment";
var shader13 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var name14 = "ltcHelperFunctions";
var shader14 = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/clusteredLightingFunctions.js
var name15 = "clusteredLightingFunctions";
var shader15 = `struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
//# sourceMappingURL=chunk-643EGQ2L.js.map
