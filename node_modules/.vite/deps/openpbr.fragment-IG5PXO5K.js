import "./chunk-GRM6LHPU.js";
import "./chunk-M235U7IH.js";
import "./chunk-R6CXLCZG.js";
import "./chunk-VZMFZZRJ.js";
import "./chunk-OW7YCHXZ.js";
import "./chunk-3PJU5P3W.js";
import "./chunk-FYNHW3HL.js";
...
var shader3 = `#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(DETAIL)
...
// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBlockAmbientOcclusion.js
var name7 = "openpbrBlockAmbientOcclusion";
var shader7 = `struct ambientOcclusionOutParams
...
var shader12 = `vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
var shader13 = `float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
var name14 = "openpbrEnvironmentLighting";
var shader14 = `#ifdef REFLECTION
...
var name15 = "openpbrDirectLightingInit";
...
var name16 = "openpbrDirectLighting";
...
var name17 = "openpbrPixelShader";
var shader17 = `#define OPENPBR_FRAGMENT_SHADER
...
var openpbrPixelShader = { name: name17, shader: shader17 };
export {
  openpbrPixelShader
};
//# sourceMappingURL=openpbr.fragment-IG5PXO5K.js.map
