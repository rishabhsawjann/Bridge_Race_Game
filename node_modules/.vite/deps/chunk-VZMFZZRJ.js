...
var name10 = "fogFragmentDeclaration";
...
var name11 = "depthPrePass";
var shader11 = `#ifdef DEPTHPREPASS
...
var name14 = "oitFragment";
var shader14 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var name15 = "decalFragmentDeclaration";
...
var name16 = "ltcHelperFunctions";
var shader16 = `vec2 LTCUv( const in vec3 N,const in vec3 V,const in float roughness ) {const float LUTSIZE=64.0;const float LUTSCALE=( LUTSIZE-1.0 )/LUTSIZE;const float LUTBIAS=0.5/LUTSIZE;float dotNV=saturate( dot( N,V ) );vec2 uv=vec2( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
//# sourceMappingURL=chunk-VZMFZZRJ.js.map
