    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-SFCEJKGI.js"), import("./openpbr.fragment-FIGK7LG6.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-TC3XNVB7.js"), import("./openpbr.fragment-IG5PXO5K.js")]);
        }
...
//# sourceMappingURL=openPbrMaterial-EVLOAWKP.js.map
