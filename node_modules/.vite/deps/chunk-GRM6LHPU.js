...
var shader3 = `vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var shader6 = `float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
var name10 = "pbrBlockNormalGeometric";
var shader10 = `vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
var name11 = "pbrBlockImageProcessing";
var shader11 = `#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
var name12 = "pbrBlockPrePass";
var shader12 = `#if SCENE_MRT_COUNT>0
...
//# sourceMappingURL=chunk-GRM6LHPU.js.map
